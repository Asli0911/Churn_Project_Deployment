...
st.sidebar.title("Will Your Employee Churn")
...
st.image(im, width=500, caption=("Streamlit Churn Prediction App"))

#st.cache()
rf_model = pickle.load(open('rf_model.pkl', 'rb'))
gbf_model = pickle.load(open('gbf_model.pkl', 'rb'))
...
modell=st.selectbox("Select a Model", ("Gradient Boosting Classifier", "Random Forest Classifier"))
...
if modell=="Gradient Boosting Classifier":
    prediction = gbf_model.predict(df)
else:
